...
rem Do not do this because it does not correctly find VS2017's vars file
rem and thus uses the incorrect MSBuild. Since this is commented out, you
rem must run this script from the "Developer Command Prompt" of the VS
rem version you wish to target (e.g. VS2017). You still must pass the
rem /p:PlatformToolset=vXXX argument to choose which platform toolset it
rem will pick (it will default to VS2015).
rem call "%dir%env.bat" %vs_platf% >nul
